...
async def draw_music_info(music: Music, qqid: Optional[int] = None, user: Optional[UserInfo] = None) -> MessageSegment:
    ...
    mr.draw(600, 1212, 22, f'Designed by Yuri-YuzuChaN & BlueDeer233|由 sakura bot 生成', default_color, 'mm')
    ...
    try:
        ...
        for num, info in enumerate(diff):
            ...
            if info:
                ...
                tb.draw(510, 292 + y * num, 38, f'{info.achievements:.4f}%', color, 'lm')
        ...
        mr.draw(600, 827, 22, f'Designed by Yuri-YuzuChaN & BlueDeer233|由 sakura bot 生成', color, 'mm')
